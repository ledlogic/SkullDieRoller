...
uint8_t
  ...
  gazeFrames     =  20; // Duration of eye movement (smaller = faster)
int8_t
...
if(gazeCountdown != 0) {
  ...
  if(--blinkCountdown == 0) blinkCountdown = random(5, 50);
